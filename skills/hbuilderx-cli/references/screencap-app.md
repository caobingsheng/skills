...
```bash
# Mac 电脑 使用 cli 对 hello-uni-app-x 项目 Android App 截图
...
# Windows 电脑：使用 cli 对 hello-uni-app-x 项目 Android App 截图
...
```bash
# Mac 电脑 使用 cli 对 hello-uni-app-x 项目 iOS App 截图（真机）
...
# Windows 电脑：使用 cli 对 hello-uni-app-x 项目 iOS App 截图（真机）
...
```bash
# Mac 电脑 使用 cli 对 hello-uni-app-x 项目 鸿蒙 App 截图
...
# Windows 电脑：使用 cli 对 hello-uni-app-x 项目 鸿蒙 App 截图
